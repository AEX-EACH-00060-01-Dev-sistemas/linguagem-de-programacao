...
Em linguagens de mais baixo nível, como C e Rust, um vetor não pode ter elementos de diferentes tipos, ou seja, o bloco de memória reservado para um array